...
export GAZEBO_RESOURCE_PATH=/usr/share/gazebo-6.1:$SONIA_WORKSPACE_ROOT/gui_nessie/ressources/
...
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/usr/lib/x86_64-linux-gnu/gazebo-6.1/plugins
