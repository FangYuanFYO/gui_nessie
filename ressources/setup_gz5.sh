...
export GAZEBO_RESOURCE_PATH=/usr/share/gazebo-5.0:$SONIA_WORKSPACE_ROOT/simsonia-gazebo/ressources/
...
export LD_LIBRARY_PATH=/usr/lib/x86_64-linux-gnu/gazebo-5.0/plugins
